...
which you can do by responding with specific action commands if required (handled by the system).
If the user asks for system stats, just provide a polite response, as the system will inject the stats.
"""
